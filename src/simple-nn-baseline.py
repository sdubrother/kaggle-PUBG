...
# coding=utf-8
"""
# Author: bjluoyahui@corp.netease.com
# Created Time : Thu 03 May 2018 11:28:13 AM CST
# File Name: simple-nn-baseline.py
# Copyright: 2018 NetEase. All rights reserved.
# Description: simple nn baseline.
# Time:2018/10/14 21:57
"""
import numpy as np
import pandas as pd
...
mlp = MLP(layer_size=[x_train.shape[1], 28, 28, 28, 1], regularization=1, output_shrink=0.1, output_range=[-1, 1],
          loss_type="hardmse")
...
aux = df_test.groupby(['matchId', 'groupId'])['winPlacePercPred'].agg('mean').groupby('matchId').rank(
